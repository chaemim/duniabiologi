          ...
          <ul class="list-unstyled">
            <li  class="@if(url(asset('/admin/dashboard')) == request()->url()) active @endif" >
              ...
              <li class="@if(url(asset('/admin/artikel')) == request()->url()) active @endif">
                <a href="{{asset('admin/artikel')}}"> <i class="fa fa-sticky-note"></i>Modul</a></li>
                
                <li class="@if(url(asset('/admin/hasil')) == request()->url()) active @endif">
                  <a href="{{asset('admin/hasil')}}"> <i class="fa fa-edit"></i>Hasil Tes</a></li>
                  ...
                  <a href="{{asset('admin/user')}}"> <i class="fa fa-user"></i>User</a></li>
                
                <li class="@if(url(asset('/admin/setting')) == request()->url()) active @endif">
                  <a href="{{asset('admin/setting')}}"> <i class="fa fa-cog"></i>Setting</a></li>
